  ...
  return (
    <>
      ...
      <div className="flex flex-row w-screen h-screen">
        <div className="w-2/4 bg-zinc-700 h-full flex justify-center items-center text-center">
          <div className="p-2 w-[320px] border-y-2 border-white">
            <h1 className="text-white text-hXL font-bold">
              Kanban Project Assignment by ADITYASINGH!
            </h1>
          </div>
        </div>
        <div className="w-2/4 bg-black h-full flex justify-center items-center">
          <div className="h-[96px] flex flex-col justify-between items-center  ">
            ...
            <div className="flex flex-row justify-center w-[420px]">
              {Object.values(providers).map((provider) => {
                return (
                  <div key={provider.name}>
                    <button
                      className="flex flex-row justify-center items-center w-[200px] h-[48px] bg-white p-2 rounded-[24px] text-hM text-purple"
